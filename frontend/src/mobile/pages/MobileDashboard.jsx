                      ...
                      return (
                        <React.Fragment key={`r1-${st.id}`}>
                          ...
                          {i < steps.length - 1 && (() => {
                            ...
                            return (
                              <div className="flex-1 flex items-center relative h-8 min-w-[50px] px-1">
                                ...
                                <svg className={`w-3 h-3 absolute right-0 transition-all ${isNextStepDone ? (isArrowBottleneck ? 'text-orange-500' : 'text-[#00e5ff]') : isNextStepActive ? 'text-[#00e5ff] animate-pulse' : 'text-slate-800'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="4.5" style={{ transform: 'translateX(1px)' }}>
                      ...
                      return (
                        <React.Fragment key={`r2-${st.id}`}>
                          <div className="w-16 text-center shrink-0">
                            <span className={`text-[10px] font-black tracking-tighter block whitespace-nowrap overflow-ellipsis ${isBottleneck ? 'text-[#fb923c]' : isDone ? 'text-[#00e5ff]' : isActive ? 'text-[#00e5ff]' : 'text-slate-500'}`}>{st.label}</span>
                          </div>
                          {i < steps.length - 1 && (
                          ...
                          {i < steps.length - 1 && (() => {
                            ...
                            return (
                              <div className="flex-1 flex justify-center px-1 min-w-[50px]">
                                {durationObj ? (
                                  <span className={`text-[9.5px] font-black px-1.5 py-0.5 rounded border shadow-sm font-mono whitespace-nowrap ${isArrowBottleneck ? 'bg-orange-500/20 text-[#fb923c] border border-orange-500/40 animate-pulse' : 'bg-[#00e5ff]/15 text-[#00e5ff] border border-[#00e5ff]/30 shadow-[0_0_10px_rgba(0,229,255,0.05)]'}`}>
                                    {durationObj.text}
                                  </span>
                                ) : (
