            ...
            {visibleSms.length > 0 ? visibleSms.map((msg) => {
              ...
              return (
                <div key={`sms-${msg.inc_id}`}
                  ...
                  <p className="text-[15px] font-bold leading-relaxed break-all whitespace-pre-wrap text-[#ffffff] tracking-tight">
                    {msg.message}
                  </p>
